...
> 本檔僅供 Claude Code 使用（其他代理請忽略）。使用者 2026-07-14 定案、2026-07-18 擴充定案（架構設計、對抗審查格式、驗收紀律）、2026-07-20 擴充定案（降級產出 registry）、**2026-07-26 修訂定案（fable 使用範圍收斂至資安領域、架構設計改 opus）**；另一專案的具體示例已改寫為本專案原生條文。
