...
- **規則嚴謹度**：中
  <!-- 寬鬆／中／嚴謹 -->
- **戰役長度預期**：長期
  <!-- 單次／短期／長期（預設長期）。主持人據此配速：短團＝倒數鐘調短、鉤子收斂、主線提早收尾；
       長團＝主線鋪展、支線發散。抵達尾聲時的收尾流程見 protocol/PLAYBOOK.md〈戰役收尾〉。 -->
- **遊玩模式**：單人
  <!-- 單人（預設）＝一位玩家一位角色。
       共窗多人（實驗，Hot Seat）＝一位主持人與數位玩家共用單一對話窗口；填「共窗多人」並在下方「本局備註」列出各玩家與角色 id。
       實驗模式；單一窗口無法對在場玩家藏字，PC 間祕密走桌外約定。詳見 protocol/PLAYBOOK.md〈共窗多人〉。 -->
- **主角**：（未填）
